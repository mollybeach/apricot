...
import { AddProductionArtistsValidation } from './ProductionsValidationSchema';
...
export default function AddArtists(props: AddArtistsProps) {
  ...
  const { handleSubmit, control, reset } = AddProductionArtistsValidation();
  ...
  const onSubmit = async (data: any) => {
    try {
      ...
      await queryClient.invalidateQueries(['artists'], data);
      reset();
      onClose();
    } catch (e) {
      setAlertState({
